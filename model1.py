...
lstm = layers.LSTM(299, input_shape=(299, 1), return_sequences=True)(inputs)
batch = layers.BatchNormalization()(lstm)  # Batch normalization can be helpful
attention = maximal.Attention(299)(batch, batch, batch)
weighted_sum = layers.Multiply()([batch, attention])
lstm = layers.LSTM(128, return_sequences=True)(weighted_sum)
batch = layers.BatchNormalization()(lstm)
lstm = layers.LSTM(64, return_sequences=False)(batch)
batch = layers.BatchNormalization()(lstm)
flat = layers.Flatten()(batch)
